...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'stock/approvals', name: 'ApprovalList', component: () => import('../views/stock/ApprovalList.vue'), meta: { title: '领用审批' } },
      { path: 'assets/:id/timeline', name: 'AssetTimeline', component: () => import('../views/assets/AssetTimeline.vue'), meta: { title: '资产时间线' } },
      ...
      { path: 'reports/depreciation', name: 'Depreciation', component: () => import('../views/reports/Depreciation.vue'), meta: { title: '折旧报表' } },
